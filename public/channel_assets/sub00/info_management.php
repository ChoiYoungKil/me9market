                ...
                <div class="row">
                    <div class="box box1">
                        ...
                        <div class="conbx">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3">
                                                    <div class="bank_bx">
                                                        ...
                                                        <input type="text" class="bank1" placeholder="계좌번호 (‘-’없이 숫자만 입력)" required="required" >
                            ...
                            <div class="con_w">
                                <div class="ttl01">회원사 판매권한 정보 <span class="col2">( M9 Market 의 Shop 채널에서 공유 및 공동구매 상품을 판매하기 위해서는 판매인증이 필요합니다. )</span></div>
                                <div class="tb01">
                                    <table>
                                        <colgroup>
                                            <col width="175px">
                                    ...
                                    <table>
                                        ...
                                        <tbody class="textL">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3">
                                                    <div class="f_img">
                                                        <div class="img_w" style="background-image:url(../images/sub/thumbnail02.jpg)"></div>
                                                    </div>
                                                    <div class="fileBox">
                                                        <input type="text" class="fileName" readonly="readonly" placeholder="">
