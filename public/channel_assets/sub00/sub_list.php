                                                                    ...
                                                                    <tr>
                                                                        <td class="pr0">
                                                                            <select required="required">
                                                                                <option value="" disabled="" selected="">회원번호 선택</option>
                                                        ...
                                                        <div class="tb01">
                                                            <table>
                                                                ...
                                                                <tbody class="textL">
                                                                    ...
                                                                    <tr>
                                                                        <th class="w160"><span>회원아이디</span></th>
                                                                        <td colspan="3"><a class="fcol2 link" href="mailto:</a>">test@test.com</a></td>
                                                                    </tr>
                                                                    <tr>
                                                                ...
                                                                <tbody class="textL">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="3">
                                                                            <ul class="chk02">
                                                                                <li>
                                                                                    <input type="checkbox" name="pop1_1_chk1" id="pop1_1_chk1_1" checked="">
                                                                                    <label for="pop1_1_chk1_1">Shop 채널</label>
                                                                                </li>
                                                                                <li>
                                                                                    <input type="checkbox" name="pop1_1_chk1" id="pop1_1_chk1_2">
                                                                                    <label for="pop1_1_chk1_2">상품관리</label>
                                                                                </li>
                                                                                <li>
                                                                                    <input type="checkbox" name="pop1_1_chk1" id="pop1_1_chk1_3">
                                                                                    <label for="pop1_1_chk1_3">공동상품관리</label>
                                                                                </li>
                                                                                <li>
                                                                                    <input type="checkbox" name="pop1_1_chk1" id="pop1_1_chk1_4">
                                                                ...
                                                                <tbody class="textL">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="3">
                                                                            <ul class="chk02">
                                                                                <li>
                                                                                    <input type="checkbox" name="pop3_1_chk1" id="pop3_1_chk1_1" checked="">
                                                                                    <label for="pop3_1_chk1_1">Shop 채널</label>
                                                                                </li>
                                                                                <li>
                                                                                    <input type="checkbox" name="pop3_1_chk1" id="pop3_1_chk1_2">
                                                                                    <label for="pop3_1_chk1_2">상품관리</label>
                                                                                </li>
                                                                                <li>
                                                                                    <input type="checkbox" name="pop3_1_chk1" id="pop3_1_chk1_3">
                                                                                    <label for="pop3_1_chk1_3">공동상품관리</label>
                                                                                </li>
                                                                                <li>
                                                                                    <input type="checkbox" name="pop3_1_chk1" id="pop3_1_chk1_4">
