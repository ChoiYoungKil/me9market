                        ...
                        <div class="conbx">
                            <div class="con_w">
                                <div class="list_top1 btn">
                                    ...
                                    <div class="btn_bx">
                                        <a href="../sub01/shop_product01.php" class="btn01 col2">판매상품</a>
                                        <a href="#" class="btn01 col4">판매중지상품</a>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="#" class="btn02 col1">판매재개</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>00</td>
                                ...
                                <!-- 판매상품 추가 팝업 -->
                                <!-- 지사상품 -->
                                <?php include __DIR__ . "/../sub01/pop.shop_product_own.php"; ?>
                                <!-- 공유상품 -->
                                <?php include __DIR__ . "/../sub01/pop.shop_product_public.php"; ?>
                                <!-- 부분고유상품 -->
                                <?php include __DIR__ . "/../sub01/pop.shop_product_partial.php"; ?>
