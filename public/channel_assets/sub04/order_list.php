                    ...
                    <div class="box box1">
                        <div class="conbx">
                            <div class="con_w">
                                <div class="tab_bx1">
                                    <ul>
                                        <li><a href="#" class="on"><span>주문목록</span></a></li>
                                        <li><a href="../sub04/order_cancel_list.php"><span>취소목록</span></a></li>
                                ...
                                <!-- 주문번호 클릭시 주문 상세 보기 -->
                                <!-- 주문 정보 팝업 -->
                                <?php include __DIR__ . "/../sub04/pop.order_info.php"; ?>
                                <!-- 정상 주문 팝업 -->
                                <?php include __DIR__ . "/../sub04/pop.order_normal.php"; ?>
                                <!-- 취소 주문 팝업 -->
                                <?php include __DIR__ . "/../sub04/pop.order_cancel.php"; ?>
                                <!-- 반품 주문 팝업 -->
                                <?php include __DIR__ . "/../sub04/pop.order_return_request.php"; ?>
                                <!-- 교환 주문 팝업 -->
                                <?php include __DIR__ . "/../sub04/pop.order_exchange_request.php"; ?>
                            </div>
                        </div>
                    </div>
                </div>
