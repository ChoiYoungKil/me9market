    ...
    <div id="contents">
        <div class="row">
            <div class="box box1">
                ...
                <div class="conbx">
                    <div class="con_w">
                        <form method="GET" action="{{ route('channel.product_public') }}" id="productSearchForm">
                        <div class="tb01">
                            <table>
                                <colgroup>
                                    <col width="160px">
                                ...
                                <tbody class="textL">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <ul class="chk01">
                                                <li>
                                                    <input type="radio" name="status" id="public_status_all" value="" {{ ($filters['status'] ?? '') === '' ? 'checked' : '' }}>
                                                    <label for="public_status_all">전체</label>
                                                </li>
                                                <li>
                                                    <input type="radio" name="status" id="public_status_sale" value="1" {{ (string)($filters['status'] ?? '') === '1' ? 'checked' : '' }}>
                                                    <label for="public_status_sale">판매</label>
                                                </li>
                                                <li>
                                                    <input type="radio" name="status" id="public_status_stop" value="0" {{ (string)($filters['status'] ?? '') === '0' ? 'checked' : '' }}>
                                                    <label for="public_status_stop">중지</label>
                                                </li>
                                                <li>
                                                    <input type="radio" name="status" id="public_status_stop_notice" value="stop_notice" {{ ($filters['status'] ?? '') === 'stop_notice' ? 'checked' : '' }}>
                                                    <label for="public_status_stop_notice">판매중지예고</label>
                                                </li>
                                            </ul>
                                        </td>
                                    </tr>
                                ...
                                <tbody>
                                    @forelse($products as $index => $product)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ url()->current() }}" class="btn02 col2 pop_btn" data-pop="pop3_1" data-id="{{ $product->id }}">보기</a>
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
