            ...
            <div class="box box1">
                ...
                <div class="conbx">
                                            ...
                                            <ul class="typeC01">
                                                <li>
                                                    <div class="typeC_w">
                                                        ...
                                                        <input type="text" value="" required="required" class="t02"
                                                            placeholder="옵션명">
                                                        <input type="text" value="" required="required" class="t03"
                                                            placeholder="비고내용">
                                                        <input type="text" value="" required="required" class="t02"
                                                            placeholder="수량입력(개)">
                                                ...
                                                <li>
                                                    <div class="typeC_w">
                                                        ...
                                                        <input type="text" value="" required="required" class="t02"
                                                            placeholder="옵션명 ex)사이즈">
                                                        <input type="text" value="" required="required" class="t04"
                                                            placeholder="선택옵션 내용">
                                                        <input type="text" value="" required="required" class="t02"
                                                            placeholder="수량입력(개)">
                                                        <div class="del">삭제</div>
                            ...
                            <table>
                                ...
                                <tbody class="textL">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <p>공유 제공자 이익 비용 <input class="w160" type="text" value="" required="required"> 원
                                            </p>
                                            <p class="mt5">판매비용 <input class="w160" type="text" value=""
                                                    required="required"> 부터 ~ <input class="w160" type="text" value=""
                                                    required="required"> 원 사이 설정가능</p>
                                            ...
                                            <div>
                                                <ul class="chk01">
                                                    ...
                                                    <li class="mr5">
                                                        ...
                                                        <label for="radio4_2_3_2">비율비용
                                                            (%)&nbsp;&nbsp;/&nbsp;&nbsp;개당&nbsp;&nbsp;<input class="w160"
                                                                type="text" value="" required="required">&nbsp;원</label>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="mt5">
                            ...
                            <table>
                                ...
                                <tbody class="textL">
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            최소 <input class="w160" type="text" value="" required="required"> 개 부터 최대 <input
                                                class="w160" type="text" value="" required="required"> 개 까지 구매가능
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <div class="con_w">
                        ...
                        <div class="btm_btn mt10">
                            <a href="{{ route('channel.product_own') }}" class="col5">목록</a>
                            <a href="#">등록</a>
                        </div>
