                ...
                <div class="box box1">
                    ...
                    <div class="tab_bx1">
                        <ul>
                            ...
                            <li><a href="{{ route('channel.product_request') }}" class="on"><span>판매 요청 관리</span></a></li>
                        </ul>
                    </div>
                                    ...
                                    <tbody>
                                        @forelse($requests as $index => $req)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn02 col5 pop_btn" data-pop="pop_detail_{{ $req->id }}">보기</button>
                                                </td>
                                            </tr>
                                                    ...
                                                    <div class="pop_inner">
                                                        <div class="pop_con w640">
                                                            ...
                                                            <div class="btm_btn mt10">
                                                                @if($req->status == 0)
                                                                    <button type="button" class="btn01 col2" onclick='updateRequestStatus("{{ $req->id }}", 1); return false;'>허용</button>
                                                                    <button type="button" class="btn01 col4" onclick='updateRequestStatus("{{ $req->id }}", 2); return false;'>거부</button>
                                                                @endif
                                                                <button type="button" class="col5 close_btn">닫기</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
