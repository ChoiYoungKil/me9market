            ...
            <div class="row">
                <div class="box box1">
                    ...
                    <div class="conbx">
                        ...
                        <div class="con_w">
                            <div class="ttl01">Shop 채널 로고 이미지 <span class="col2 fs2">(Shop 채널 로고를 생략 할 경우 채널명 노출)</span>
                            </div>
                            <div class="tb01">
                                <table>
                                    <colgroup>
                                            ...
                                            <td>
                                                <div class="r_btn_w w560">
                                                    ...
                                                    <div class="fileBox">
                                                        ...
                                                        <input type="file" id="uploadBtn2_1" class="uploadBtn"
                                                            name="bbs_file1">
                                                        <div class="del_btn">삭제</div>
                                                    </div>
                                                </div>
                                ...
                                <table>
                                    ...
                                    <tbody class="textL">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <input class="w200" type="text" value="" required="required"> % (총 판매금액에서
                                                지급되는 %)
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <input class="w200" type="text" value="" required="required"> 원 (판매당 지급되는
                                                비용)
                                            </td>
                                        </tr>
                                    </tbody>
