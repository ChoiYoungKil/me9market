                            ...
                            <table>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:void(0);" class="btn02 col2 pop_btn" data-pop="pop1_3_4">판매허용</a>
                                        </td>
                                        <td>
                                            <a href="javascript:void(0);" class="btn02 col5 pop_btn" data-pop="pop1_3_2">추가하기</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>00</td>
                                        ...
                                        <td>
                                            <a href="javascript:void(0);" class="btn02 pop_btn" data-pop="pop1_3_4">판매요청중</a>
                                        </td>
                                        <td>
                                            <a href="javascript:void(0);" class="btn02 col5 pop_btn" data-pop="pop1_3_2">추가하기</a>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:void(0);" class="btn02 col5 pop_btn" data-pop="pop1_3_4">판매요청</a>
                                        </td>
                                        <td>
                                            <a href="javascript:void(0);" class="btn02 col5 pop_btn" data-pop="pop1_3_2">추가하기</a>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:void(0);" class="btn02 col4 pop_btn" data-pop="pop1_3_4">요청거부</a>
                                        </td>
                                        <td>
                                            <a href="javascript:void(0);" class="btn02 col5 pop_btn" data-pop="pop1_3_2">추가하기</a>
                                        </td>
    ...
    <div class="pop_w">
        <div class="pop_inner">
            <div class="pop_con w640">
                ...
                <!-- 하단버튼 -->
                <div class="btm_btn mt10">
                    <a href="javascript:void(0);">재요청하기</a><!-- 판매요청하기 -->
                    <a href="javascript:void(0);" class="col5 close_btn">닫기</a>
                </div>
            </div>
        </div>
