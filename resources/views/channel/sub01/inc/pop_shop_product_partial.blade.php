            ...
            <div class="pop_con">
                ...
                <div class="tab_bx1">
                    <ul>
                        ...
                        <li><a href="{{ url()->current() }}" data-pop="pop1_2"><span>공유상품</span></a></li>
                        <li><a href="{{ url()->current() }}" class="on"><span>부분공유상품</span></a></li>
                    </ul>
                </div>
                            ...
                            <table>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url()->current() }}" class="btn02 col2 pop_btn" data-pop="pop1_3_3">보기</a>
                                        </td>
                                        <td>
                                            <a href="{{ url()->current() }}" class="btn02 col2 pop_btn" data-pop="pop1_3_4">판매허용</a>
                                        </td>
                                        <td>
                                            <a href="{{ url()->current() }}" class="btn02 col5 pop_btn" data-pop="pop1_3_2">추가하기</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>00</td>
                                        ...
                                        <td>
                                            <a href="{{ url()->current() }}" class="btn02 pop_btn" data-pop="pop1_3_4">판매요청중</a>
                                        </td>
                                        <td>
                                            <a href="{{ url()->current() }}" class="btn02 col5 pop_btn" data-pop="pop1_3_2">추가하기</a>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url()->current() }}" class="btn02 col5 pop_btn" data-pop="pop1_3_4">판매요청</a>
                                        </td>
                                        <td>
                                            <a href="{{ url()->current() }}" class="btn02 col5 pop_btn" data-pop="pop1_3_2">추가하기</a>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url()->current() }}" class="btn02 col4 pop_btn" data-pop="pop1_3_4">요청거부</a>
                                        </td>
                                        <td>
                                            <a href="{{ url()->current() }}" class="btn02 col5 pop_btn" data-pop="pop1_3_2">추가하기</a>
                                        </td>
...
<!-- 부분공유상품 팝업 ==> 추가하기 팝업 -->
<div class="popup_bx" data-id="pop1_3_4">
    <div class="pop_w">
        <div class="pop_inner">
            <div class="pop_con w640">
                <div class="close_btn close1">닫기</div>
                ...
                <!-- 하단버튼 -->
                <div class="btm_btn mt10">
                    <a href="{{ url()->current() }}">재요청하기</a><!-- 판매요청하기 -->
                    <a href="{{ url()->current() }}" class="col5 close_btn">닫기</a>
                </div>
            </div>
        </div>
