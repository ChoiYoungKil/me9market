<div class="popup_bx" data-id="pop1_4">
    <div class="pop_w">
        <div class="pop_inner">
            <div class="pop_con">
                            ...
                            <table>
                                ...
                                <tbody id="pop_return_order_items_body">
                                    <tr>
                                        ...
                                        <td>
                                            한진택배 &nbsp;<span class="fcol3">22332323</span>&nbsp; <a href="{{ url()->current() }}"
                                                class="btn02">삭제</a>
                                        </td>
                                        <td>배송대기</td>
...
<!-- 반품 주문 팝업 ==> 반품회수완료 팝업 -->
<div class="popup_bx" data-id="pop1_4_2">
    <div class="pop_w">
        <div class="pop_inner">
            <div class="pop_con w560">
                ...
                <div class="conbx">
                    <div class="con_w">
                        <div class="imp_bx01 bN">
                            <div class="txt2 mt0">반품회수완료 상태로 전환하시겠습니까?</div>
                            <!--<div class="txt2">반품요청 상태에서만 반품회수완료 상태로 전환이 가능합니다.</div>-->
                        </div>
                    </div>
                </div>
                ...
                <div class="btm_btn mt10">
                    <a href="{{ url()->current() }}" id="btn_return_received_confirm">확인</a>
                    <a href="{{ url()->current() }}" class="col5 close_btn">닫기</a>
                </div>
            </div>
        </div>
...
<!-- 반품 주문 팝업 ==> 반품확정 팝업 -->
<div class="popup_bx" data-id="pop1_4_3">
    <div class="pop_w">
        <div class="pop_inner">
            <div class="pop_con w560">
                <div class="close_btn close1">닫기</div>
                <div class="conbx">
                    <div class="con_w">
                        <div class="imp_bx01 bN">
                            <div class="txt2 mt0">반품확정 상태로 전환하시겠습니까?</div>
                            <!--<div class="txt2">반품회수완료 상태에서만 반품확정 상태로 전환이 가능합니다.</div>-->
                        </div>
                    </div>
                </div>
                ...
                <!-- 하단버튼 -->
                <div class="btm_btn mt10">
                    <a href="{{ url()->current() }}" id="btn_return_approve_confirm">확인</a>
                    <a href="{{ url()->current() }}" class="col5 close_btn">닫기</a>
                </div>
            </div>
        </div>
...
<!-- 반품 주문 팝업 ==> 반품보류 팝업 -->
<div class="popup_bx" data-id="pop1_4_4">
    <div class="pop_w">
        <div class="pop_inner">
            <div class="pop_con w800">
                <div class="close_btn close1">닫기</div>
                <div class="page_info type2">
                    <div class="ttl">반품 보류</div>
                </div>
                <div class="conbx">
                    <div class="con_w">
                        <div class="tb01">
...
<!-- 반품 주문 팝업 ==> 반품철회 팝업 -->
<div class="popup_bx" data-id="pop1_4_5">
    <div class="pop_w">
        <div class="pop_inner">
            <div class="pop_con w560">
                <div class="close_btn close1">닫기</div>
                <div class="conbx">
                    <div class="con_w">
                        <div class="imp_bx01 bN">
                            <div class="txt2 mt0">반품철회시 해당 주문은 배송중 상태로 변경됩니다. <br>반품철회 상태로 전환하시겠습니까?</div>
                            <!--<div class="txt2">반품요청 상태에서만 반품철회 상태로 전환이 가능합니다.</div>-->
                        </div>
                    </div>
                </div>
                ...
                <!-- 하단버튼 -->
                <div class="btm_btn mt10">
                    <a href="{{ url()->current() }}" id="btn_return_reject_confirm">확인</a>
                    <a href="{{ url()->current() }}" class="col5 close_btn">닫기</a>
                </div>
            </div>
        </div>
...
<!-- 반품 주문 팝업 ==> 송장수정 팝업 -->
<div class="popup_bx" data-id="pop1_4_6">
    <div class="pop_w">
        <div class="pop_inner">
            <div class="pop_con w800">
                <div class="close_btn close1">닫기</div>
