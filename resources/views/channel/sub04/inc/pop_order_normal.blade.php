            ...
            <div class="pop_con">
                ...
                <div class="tab_bx1">
                    <ul>
                        ...
                        <li><a href="{{ url()->current() }}" class="on"><span>정상 주문</span></a></li>
                ...
                <div class="conbx">
                    ...
                    <div class="con_w">
                        ...
                        <div class="mt10">
                            <a href="{{ url()->current() }}" class="btn01 col3 pop_btn" data-pop="pop1_2_2">결제완료</a>
                            <a href="{{ url()->current() }}" class="btn01 col3 pop_btn" data-pop="pop1_2_3">배송대기</a>
                            <a href="{{ url()->current() }}" class="btn01 col3 pop_btn" data-pop="pop1_2_3">배송중</a>
                            <a href="{{ url()->current() }}" class="btn01 pop_btn" data-pop="pop1_2_4">반품 요청</a>
                            <a href="{{ url()->current() }}" class="btn01 pop_btn" data-pop="pop1_2_5">교환 요청</a>
                            <a href="{{ url()->current() }}" class="btn01 pop_btn" data-pop="pop1_2_6">취소 요청</a>
                        </div>
                    </div>
                </div>
