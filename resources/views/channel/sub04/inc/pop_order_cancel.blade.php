            ...
            <div class="pop_con">
                ...
                <div class="tab_bx1">
                    <ul>
                        ...
                        <li><a href="{{ url()->current() }}" class="on"><span>취소 주문</span></a></li>
                ...
                <div class="conbx">
                    ...
                    <div class="con_w">
                        ...
                        <div class="mt10">
                            <a href="{{ url()->current() }}" class="btn01 col3 pop_btn" data-pop="pop1_3_2">취소 거부</a>
                            <a href="{{ url()->current() }}" class="btn01 pop_btn" data-pop="pop1_3_3">취소 완료</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="pop_inner">
            <div class="pop_con w560">
                ...
                <div class="btm_btn mt10">
                    <a href="{{ url()->current() }}" id="btn_cancel_reject_confirm">확인</a>
                    <a href="{{ url()->current() }}" class="col5 close_btn">닫기</a>
                </div>
            </div>
        </div>
    ...
    <div class="pop_w">
        <div class="pop_inner">
            <div class="pop_con w560">
                ...
                <!-- 하단버튼 -->
                <div class="btm_btn mt10">
                    <a href="{{ url()->current() }}" id="btn_cancel_approve_confirm">확인</a>
                    <a href="{{ url()->current() }}" class="col5 close_btn">닫기</a>
                </div>
            </div>
        </div>
