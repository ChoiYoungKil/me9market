                ...
                <div class="conbx">
                    <div class="con_w">
                        <div class="list_top1 btn">
                            ...
                            <div class="btn_bx">
                                <a href="javascript:void(0);" class="btn01 col5 pop_btn" data-pop="pop1_1">취소/환불안내 등록</a>
                            </div>
                        </div>
                        <div class="tb01 ovS">
                            <table>
                                ...
                                <tbody>
                                    @forelse($policies as $policy)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="javascript:void(0);" class="btn02 col5 pop_btn view-policy" data-pop="pop2_1"
                                                    data-id="{{ $policy->id }}">보기</a>
                                                <a href="javascript:void(0);" class="btn02 col2 copy-policy" data-id="{{ $policy->id }}">복사</a>
                                                <a href="javascript:void(0);" class="btn02 col7 mt5 pop_btn edit-policy" data-pop="pop3_1"
                                                    data-id="{{ $policy->id }}">수정</a>
                                                <a href="javascript:void(0);" class="btn02 mt5 delete-policy" data-id="{{ $policy->id }}">삭제</a>
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
                                ...
                                <div class="pop_inner">
                                    <div class="pop_con">
                                        ...
                                        <div class="btm_btn mt10">
                                            <a href="javascript:void(0);" id="submitCreatePolicy">취소/환불안내 등록</a>
                            ...
                            <div class="pop_w">
                                <div class="pop_inner">
                                    <div class="pop_con">
                                        ...
                                        <!-- 하단버튼 -->
                                        <div class="btm_btn mt10">
                                            <a href="javascript:void(0);" id="submitUpdatePolicy">취소/환불안내 수정</a>
                                            <a href="javascript:void(0);" class="col5 close_btn">닫기</a>
                                        </div>
                                    </div>
                                </div>
