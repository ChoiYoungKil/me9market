                        ...
                        <div class="conbx">
                            <div class="con_w">
                                ...
                                <div class="list_top1 btn">
                                    ...
                                    <div class="btn_bx">
                                        <a href="{{ url()->current() }}" class="btn01 col5 pop_btn" data-pop="pop_create">발주담당 등록</a>
                                    </div>
                                </div>
                                <div class="tb01 ovS">
                                    <table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="order-manager-actions">
                                                            <a href="{{ url()->current() }}" class="btn02 col5 pop_btn" data-pop="pop_view_{{ $manager->id }}">보기</a>
                                                            <a href="{{ url()->current() }}" class="btn02 col7 pop_btn" data-pop="pop_edit_{{ $manager->id }}">수정</a>
