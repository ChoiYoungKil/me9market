...
@section('content')
        ...
        <div id="contents">
            <div id="join" class="shopping_basket">
                <div class="top_v">
                    ...
                    <div class="tab_bx">
                        <ul>
                            <li class="on"><a href="{{ url()->current() }}">주문</a></li>
                ...
                <div class="box box1">
                    <div class="inner_bx">
                                    ...
                                    <div class="order_info">
                                                ...
                                                <form>
                                                    ...
                                                    <div class="tb_bx">
                                                        <div class="tr w100 btn_w">
                                                            ...
                                                            <a href="{{ url()->current() }}" class="s_btn">조회</a>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                                        ...
                                        <div class="con_w con2">
                                            <div class="ttl">
                                                ...
                                                <div class="r_bx">
                                                    2024-10-14 <span>&nbsp;|&nbsp;</span> 주문번호 : Me9-00929423 <a href="{{ url()->current() }}"
                                                        class="btn">주문상세</a>
                                                </div>
                                            </div>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="r_bx">
                                                        <div class="txt_w">
                                                            ...
                                                            <div class="btn">
                                                                <a class="col6 pop_btn" data-pop="pop2">취소신청</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                                                    ...
                                                    <div class="product01">
                                                        ...
                                                        <div class="txt_bx">
                                                            <div class="txt_w">
                                                                ...
                                                                <strong class="txt2">상품명상품명상품명상품명상품명상품명상품명상품명상품명상품명상품명상품명
                                                                    111111</strong>
                                                                <div class="txt3">
                                                                    <p>옵션옵션옵션옵션옵션옵션옵션옵션 1 / 2개</p>
                                                                    <p>옵션옵션옵션옵션옵션옵션옵션옵션 1 / 2개</p>
                                            ...
                                            <div class="all">
                                                <div class="txt2">무료배송 <span class="bar">&nbsp;|&nbsp;</span> <a href="{{ url()->current() }}"
                                        ...
                                        <div class="con_w con2">
                                                ...
                                                <li>
                                                    ...
                                                    <div class="r_bx">
                                                        <div class="txt_w">
                                                            ...
                                                            <div class="btn">
                                                                <a class="col5 pop_btn" data-pop="pop3">반품신청</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                                            ...
                                            <div class="all">
                                                <div class="txt2">30,000 원 미만 : 2,500 원 <span
                                                        class="bar">&nbsp;|&nbsp;</span> <a href="{{ url()->current() }}" class="btn pop_btn"
                                                ...
                                                <li>
                                                    ...
                                                    <div class="r_bx">
                                                        <div class="txt_w">
                                                            ...
                                                            <div class="btn">
                                                                <a class="col5 pop_btn" data-pop="pop3">반품신청</a>
                                                                <a class="col4 pop_btn" data-pop="pop4">교환신청</a>
                                                                <a class="col3 pop_btn" data-pop="pop5">구매확정</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                            ...
                            <div class="pop_w">
                                <div class="pop_inner">
                                    <div class="pop_con w640">
                                        ...
                                        <!-- 하단버튼 -->
                                        <div class="btm_btn">
                                            <a href="{{ url()->current() }}" class="col2">문의하기</a>
                            ...
                            <div class="pop_w">
                                <div class="pop_inner">
                                    <div class="pop_con w640">
                                        ...
                                        <div class="conbx">
                                            ...
                                            <div class="con">
                                                ...
                                                <div class="f_con">
                                                    ...
                                                    <div class="f_bx">
                                                        <div class="f_w w100">
                                                            <textarea placeholder="기타 내용을 입력해 주세요"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <!-- 하단버튼 -->
                                        <div class="btm_btn">
                                            <a href="{{ url()->current() }}" class="col5">취소신청</a>
                                            <a href="{{ url()->current() }}" class="close_btn">닫기</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <!-- 반품신청 -->
                        <div class="popup_bx" data-id="pop3">
                            <div class="pop_w">
                                <div class="pop_inner">
                                    <div class="pop_con w640">
                                        <div class="close_btn close1">닫기</div>
                                        <div class="ttl">반품신청하기</div>
                                        ...
                                        <div class="conbx">
                                            ...
                                            <div class="con">
                                                <div class="f_con">
                                                    <div class="f_bx">
                                                        <div class="f_w w100">
                                                            <ul class="chk01 mdipi">
                                                                <li>
                                                                    <input type="radio" id="pop3_radio1_1"
                                                                        name="pop3_radio1" checked>
                                                                    <label for="pop3_radio1_1">자동회수</label>
                                                                </li>
                                                                <li>
                                                                    <input type="radio" id="pop3_radio1_2"
                                                                        name="pop3_radio1">
                                                                    <label for="pop3_radio1_2">수동회수</label>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                    <div class="f_bx">
                                                        <div class="f_w w100">
                                                            <!-- 자동회수 -->
                                                            <div class="imp_txt">
                                                                <p class="txt1">반품이라고 표기해서 문 앞에 두시면 “한진택배”에서 회수합니다. <br>물품에
                                                                    문제가 없을 경우 택배비가 발생합니다.</p>
                                                            </div>

                                                            <!-- 수동회수 -->
                                                            <div class="addr_bx">
                                                                <input type="text" class="addr1" placeholder="우편번호">
                                                                <a class="btn01">우편번호찾기</a>
                                        ...
                                        <!-- 하단버튼 -->
                                        <div class="btm_btn">
                                            <a href="{{ url()->current() }}" class="col4">반품신청</a>
                                            <a href="{{ url()->current() }}" class="close_btn">닫기</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <!-- 교환신청 -->
                        <div class="popup_bx" data-id="pop4">
                            <div class="pop_w">
                                <div class="pop_inner">
                                    <div class="pop_con w640">
                                        <div class="close_btn close1">닫기</div>
                                        <div class="ttl">교환신청하기</div>
                                        ...
                                        <div class="conbx">
                                            ...
                                            <div class="con">
                                                <div class="c_ttl">교환사유</div>
                                                <div class="f_con">
                                                    <div class="f_bx">
                                                        <div class="f_w w100">
                                                            <select>
                                                                <option>다른 상품이 배송되었습니다</option>
                                                                <option>기타</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="f_con">
                                                    ...
                                                    <div class="f_bx">
                                                        <div class="f_w w100">
                                                            <!-- 자동회수 -->
                                                            <div class="imp_txt">
                                                                <p class="txt1">교환이라고 표기해서 문 앞에 두시면 “한진택배”에서 회수합니다. <br>물품에
                                                                    문제가 없을 경우 택배비가 발생합니다</p>
                                                            </div>
                                        ...
                                        <!-- 하단버튼 -->
                                        <div class="btm_btn">
                                            <a href="{{ url()->current() }}" class="col3">교환신청</a>
                                            <a href="{{ url()->current() }}" class="close_btn">닫기</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <!-- 구매확정 -->
                        <div class="popup_bx" data-id="pop5">
                            <div class="pop_w">
                                <div class="pop_inner">
                                    <div class="pop_con w640">
                                        <div class="close_btn close1">닫기</div>
                                        <div class="ttl">구매확정하기</div>
                                        ...
                                        <div class="conbx">
                                            ...
                                            <div class="con">
                                                <div class="c_ttl">별점주기</div>
                                            </div>
                                            <div class="con">
                                                <div class="star_sc01">
                                                    <ul data-star="4"> <!--data-star="0~5"-->
                                                        <li></li>
                                                        <li></li>
                                                        <li></li>
                                                        <li></li>
                                                    ...
                                                    <div class="txt1">이 상품을 구매하겠습니다.</div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <!-- 하단버튼 -->
                                        <div class="btm_btn">
                                            <a href="{{ url()->current() }}" class="col2">구매확정하기</a>
                                            <a href="{{ url()->current() }}" class="close_btn">닫기</a>
                                        </div>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        ...
        /* 별점 */
        $(".star_sc01 ul li").click(function () {
            var thisIdx = $(this).index() + 1;
            if (($(this).parent("ul").attr("data-star") == "1") && (thisIdx == 1)) {
                $(this).parent("ul").attr("data-star", "0");
            } else {
                $(this).parent("ul").attr("data-star", thisIdx);
            }
        });
