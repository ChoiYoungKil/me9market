...
@section('content')
    ...
    <div id="container_w">
        <div id="contents">
            ...
            <!--
                        <div class="row col2"><div class="box"></div></div>
                        <div class="row col2 mr0"><div class="box"></div></div>

                        <div class="row col3"><div class="box"></div></div>
                        <div class="row col3"><div class="box"></div></div>
                        <div class="row col3 mr0"><div class="box"></div></div>
                        -->
