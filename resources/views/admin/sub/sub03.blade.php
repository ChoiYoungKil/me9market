                                            ...
                                            <td>
                                                <ul class="chk01">
                                                    ...
                                                    <li>
                                                        ...
                                                        <label for="radio1_3">부분공개상품</label>
                                                    </li>
                                                </ul>
                                            </td>
                                        </tr>
                                ...
                                <table>
                                    ...
                                    <tbody class="textL">
                                        <tr>
                                            ...
                                            <td class="ovH">테스트 내용입니다. 테스트 내용입니다.</td>
                                            <td class="ovH">테스트 테스트 테스트</td>
                                            <td class="t_c">1900-01-01</td>
                                            <td class="ovH">테스트 테스트 테스트</td>
                                            <td class="ovH">테스트 테스트 테스트</td>
                                            <td class="ovH">테스트 테스트 테스트</td>
                                            <td class="ovH">테스트 테스트 테스트</td>
