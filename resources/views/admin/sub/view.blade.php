                        ...
                        <div class="con_w">
                            <div class="view01">
                                ...
                                <div class="file">
                                    ...
                                    <ul>
                                        <li><a href="{{ url()->current() }}">첨부파일명.확장자 <span>(00,000 byte)</span></a></li>
                                        <li><a href="{{ url()->current() }}">첨부파일명.확장자 <span>(00,000 byte)</span></a></li>
                                    </ul>
                                </div>
                                <div class="con">
                            ...
                            <div class="btm_btn right mt10">
                                ...
                                <a href="{{ url()->current() }}" class="col3">수정</a>
                                <a href="{{ url()->current() }}" class="col4">삭제</a>
                                <a href="{{ url()->current() }}" class="col5">목록</a>
                            </div>
                        </div>
                        <div class="con_w">
                            <!-- 댓글 -->
                            <div class="comt01">
                                ...
                                <div class="f_bx">
                                    <form>
                                        <textarea></textarea>
                                        <a href="{{ url()->current() }}" class="btn">댓글 입력</a>
                                    </form>
                                </div>
                                <ul class="c_list">
                                    <li class="list_w">
                                        ...
                                        <div class="top_bx">
                                            ...
                                            <div class="r_bx">
                                                ...
                                                <a href="{{ url()->current() }}" class="btn icon1 pop_btn" data-pop="pop1">수정</a>
                                                <a href="{{ url()->current() }}" class="btn icon2">삭제</a>
                                            </div>
                                        </div>
                                        <div class="btm_bx">
                                        ...
                                        <div class="pop_inner">
                                            <div class="pop_con">
                                                ...
                                                <div class="f_bx">
                                                    <form>
                                                        <textarea></textarea>
                                                        <a href="{{ url()->current() }}" class="btn">댓글 수정</a>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
