                                        ...
                                        <table>
                                            ...
                                            <tbody class="textL">
                                                <tr>
                                                    <td class="t_c">00</td>
                                                    <td class="ovH">
                                                        <a href="view.php" class="subject on fcol1">공지사항 입니다. 공지사항 입니다. 공지사항
                                                            입니다. 공지사항 입니다. 공지사항 입니다. 공지사항 입니다.</a>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td class="t_c">00</td>
                                                    <td class="ovH">
                                                        <a href="view.php" class="subject fcol1">일반 게시판 제목입니다. 일반 게시판 제목입니다.
                                                            일반 게시판 제목입니다. 일반 게시판 제목입니다. 일반 게시판 제목입니다. 일반 게시판 제목입니다. 일반 게시판
                                                            제목입니다. 일반 게시판 제목입니다. 일반 게시판 제목입니다. 일반 게시판 제목입니다. 일반 게시판 제목입니다.
                                                            일반 게시판 제목입니다.</a>
                                                    </td>
                                                    <td class="t_c">2025-10-01</td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="ovH">
                                                        <a href="view.php" class="subject fcol1">일반 게시판 제목입니다. 일반 게시판 제목입니다.
                                                            일반 게시판 제목입니다. 일반 게시판 제목입니다. 일반 게시판 제목입니다. 일반 게시판 제목입니다.</a>
                                                    </td>
                                                    <td class="t_c">2025-10-01</td>
                                                </tr>
                                            </tbody>
