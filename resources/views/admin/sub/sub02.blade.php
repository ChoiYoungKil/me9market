                ...
                <div class="box box2">
                    <div class="conbx">
                        ...
                        <div class="con_w">
                                    ...
                                    <tbody class="textL">
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                ...
                                                <p class="mt10">‘ <span class="fcol2">abcd1234</span> ’ 는 사용할 수 있는 아이디 입니다.
                                                </p>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <div class="f_down2">
                                                    ...
                                                    <a href="{{ url()->current() }}" class="down_btn">내려받기</a>
                            ...
                            <a href="{{ url()->current() }}" class="btn01 col4">버튼4</a>
                            <a href="{{ url()->current() }}" class="btn01 col5">버튼5</a>
                            <div class="btm_btn left">
                                <a href="{{ url()->current() }}" class="col2">버튼1</a>
                                <a href="{{ url()->current() }}" class="col3">버튼2</a>
                                <a href="{{ url()->current() }}" class="col4">버튼3</a>
                                <a href="{{ url()->current() }}" class="col5">버튼4</a>
                        ...
                        <div class="con_w">
                            ...
                            <div class="btm_btn left mt0">
                                <a href="newpage.php"
                                    onclick="window.open(this.href, '_blank', 'width=1220, height=700'); return false;">새창1</a>
                            </div>

                            <!-- 팝업버튼 -->
                            <div class="btm_btn left">
                                <a href="{{ url()->current() }}" class="pop_btn" data-pop="pop1">팝업버튼1</a>
                                <a href="{{ url()->current() }}" class="col2 pop_btn" data-pop="pop2">팝업버튼2</a>
                            </div>
                                                                    ...
                                                                    <td colspan="3">
                                                                        <div class="fileBox">
                                                                            ...
                                                                            <input type="file" id="uploadBtn2"
                                                                                class="uploadBtn" name="bbs_file1">
                                                                            <div class="del_btn">삭제</div>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            ...
                                                            <tbody class="textL">
                                                                <tr>
                                                                    ...
                                                                    <td colspan="3">
                                                                        ...
                                                                        <p class="mt10">‘ <span
                                                                                class="fcol2">abcd1234</span> ’ 는 사용할 수 있는
                                                                            아이디 입니다.</p>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="3">
                                                                        <div class="addr_bx">
                                                                            <input type="text" class="addr1 off"
                                                                                placeholder="우편번호" required="required">
                                                                            <a href="{{ url()->current() }}" class="btn01">우편번호찾기</a>
                                                                            <input type="text" class="addr2 off"
                                                                                placeholder="주소" required="required">
                                                                            <input type="text" class="addr3 off"
