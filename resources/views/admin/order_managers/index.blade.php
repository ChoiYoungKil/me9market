                    ...
                    <div class="con_w">
                        ...
                        <div class="list_top1 list-top-split">
                            ...
                            <div class="right_bx list-top-actions">
                                <div class="r_btn_w">
                                    <a href="javascript:void(0);" class="btn02 col5 pop_btn" data-pop="pop_create">발주사 등록</a>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="t_c">
                                                <div class="order-manager-actions">
                                                    <a href="javascript:void(0);" class="btn02 col5 pop_btn" data-pop="pop_edit_{{ $manager->id }}">수정</a>
