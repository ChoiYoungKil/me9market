    ...
    $sections = [
        [
            ...
            'items' => [
                ...
                ['slide' => '017-023', 'screen' => 'RF-01-06', 'name' => '비회원 주문조회', 'intent' => '주문코드와 연락처로 주문 상세, 취소/반품/교환/구매확정/문의 처리', 'url' => '/nonmember/order/check', 'state' => 'partial', 'note' => '샘플 주문 자동 생성 로직 포함'],
                ['slide' => '025-033', 'screen' => 'RF-01-07-01~08', 'name' => '로그인/회원가입/아이디·비밀번호 찾기', 'intent' => '일반 회원과 간편 회원의 가입 및 계정 복구', 'url' => '/member/login', 'state' => 'partial', 'note' => '일반/소셜 보완가입 화면과 단계별 입력 일부 구현'],
                ['slide' => '034-061', 'screen' => 'RF-01-07-09~22', 'name' => '마이페이지', 'intent' => '대시보드, 회원정보, 배송지, 탈퇴, 방문채널, 포인트, 장바구니, 찜, 주문/클레임 관리', 'url' => '/mypage/main', 'state' => 'partial', 'note' => '주문/클레임/포인트/장바구니/찜 실제 데이터 연동'],
            ],
            'flows' => [
        ...
        [
            ...
            'items' => [
                ...
                ['slide' => '069-070', 'screen' => 'RF-02-03', 'name' => '정보 관리', 'intent' => '채널 관리자 정보와 비밀번호 관리', 'url' => '/channel/settings/info', 'state' => 'partial', 'note' => '기본 정보/비밀번호 변경 구현'],
                ['slide' => '072-087', 'screen' => 'RF-02-04-01~04', 'name' => 'Shop 채널 목록/등록/상세/수정', 'intent' => '공개여부, 입장코드, 키워드, 기간, 로고, 배너, OG, 관리자 정보 설정', 'url' => '/channel/shop/list', 'state' => 'partial', 'note' => '주요 DB 컬럼과 모델 저장 경로 정리'],
                ['slide' => '088-104', 'screen' => 'RF-02-04-05~09', 'name' => 'Shop 채널 판매상품/공지', 'intent' => '자사/공유/제휴 상품을 채널에 붙이고 채널 공지 운영', 'url' => '/channel/shop/product01', 'state' => 'partial', 'note' => 'ShopChannelProduct와 공지 CRUD 연동, 세부 제약조건 추가 필요'],
        ...
        [
            ...
            'accent' => '#d97706',
            'items' => [
                ['slide' => '200-202', 'screen' => 'RF-03-01~02', 'name' => '입장코드 / 로그인 / 간편가입', 'intent' => '공개/비공개 채널 입장 및 간편 회원 가입', 'url' => '/shop-channel/gate', 'state' => 'partial', 'note' => '입장코드가 ShopChannel DB와 세션에 연결됨'],
                ['slide' => '206', 'screen' => 'RF-03-03-01', 'name' => 'Shop 채널 메인', 'intent' => '배너, 상품 진입, 채널 소개, 공지 노출', 'url' => '/shop-channel/main', 'state' => 'partial', 'note' => '채널/상품/공지/공동구매 데이터 노출'],
                ['slide' => '208-216', 'screen' => 'RF-03-04', 'name' => '상품 목록/상세/공동구매', 'intent' => '일반상품과 공동구매상품 탐색, 옵션 선택, Q&A, 판매정보 확인', 'url' => '/shop-channel/products', 'state' => 'partial', 'note' => 'ShopChannelProduct와 joint_purchases 연동'],
                ...
                ['slide' => '222-232', 'screen' => 'RF-03-05', 'name' => '주문조회/주문관리', 'intent' => '채널 구매 주문의 취소/반품/교환/구매확정/문의', 'url' => '/shop/order/details', 'state' => 'partial', 'note' => '실제 주문 상세와 취소/반품/교환/확정 상태 변경 연결, 상품 문의는 고객센터 통합 필요'],
                ['slide' => '234-235', 'screen' => 'RF-03-06', 'name' => '채널 공지사항', 'intent' => 'Shop 채널 관리자가 등록한 공지 목록/상세', 'url' => '/shop-channel/notices', 'state' => 'partial', 'note' => '채널별 공지 DB 목록 연동'],
            ],
            'flows' => [
