    ...
    $sections = [
        ...
        [
            ...
            'items' => [
                ...
                ['slide' => '168-172', 'screen' => 'RF-02-08-01', 'name' => '채널 정산관리', 'intent' => '기간별 정산 집행 현황과 상세 정산/엑셀 확인', 'url' => '/channel/settlement/list', 'state' => 'done', 'note' => '구매확정 상품, 공동구매 재가격, 쿠폰, 수수료 스냅샷 기준 정산 구현됨. 전체관리자 집행현황/첨부자료가 채널관리자에게 노출되고, 자사PG 결제분은 지급 제외하되 Me9 포인트 결제분은 SMS 비용 차감 후 지급됨'],
        ...
        [
            ...
            'items' => [
                ...
                ['slide' => '173-176', 'screen' => 'RF-02-08-02', 'name' => '전체관리자 정산관리', 'intent' => '채널아이디/정산년월 기준 집행 등록, 채널 지급액/청구액 상세 확인', 'url' => '/admin/settlements', 'state' => 'done', 'note' => '구매확정 주문 기준 settlement_runs/items 생성, 수수료/PG구분 스냅샷, 집행 타이틀/금액/첨부자료 등록, 상세 엑셀, 추가배송비 엑셀, 지급액/청구액 상세 새창 구현됨. 지급/청구 상세의 채널아이디는 Shop 채널코드로 표시하고, 자사PG는 매출액과 채널 지급액을 분리해 표시함. 정산 완료 상태변경은 사용하지 않으며 집행 현황으로 확인'],
