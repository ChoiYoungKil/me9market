    ...
    <div id="contents" style="padding: 120px 0; min-height: 600px;">
        <div class="row">
            <div class="box box1" style="max-width: 1200px; margin: 0 auto; background: #fff; padding: 30px;">
                <div class="page_info">
                    <div class="ttl" style="font-size: 28px; font-weight: bold; margin-bottom: 20px;">교환 상세 내역</div>
                ...
                <div class="conbx">
                    ...
                    <div class="con_w" style="margin-bottom: 40px;">
                        <div class="ttl01"
                            ...
                            교환 상품 <span style="font-size: 14px; color: #e91e63;">판매자 ( txx2212 )</span></div>
                        <div class="tb01">
                                ...
                                <tbody>
                                    <tr>
                                        <td style="padding: 15px; border-bottom: 1px solid #ddd; text-align:center;">
                                            <span
                                                style="display:inline-block; padding: 5px 10px; background:#eee; font-size:12px;">교환완료</span>
                                        </td>
                                        <td style="padding: 15px; border-bottom: 1px solid #ddd;">
                                            <div style="display:flex; align-items:center;">
                                                ...
                                                <div>
                                                    <p style="color:#e91e63; font-size:12px;">교환 주문번호: Me9-RE-00929111</p>
                    ...
                    <div class="con_w" style="margin-bottom: 40px;">
                        ...
                        <div class="tb01">
                            <table style="width: 100%;">
                                ...
                                <tbody class="textL">
                                    <tr>
                                        <th style="padding: 15px; background: #f9f9f9; border-bottom: 1px solid #ddd;">교환 사유
                                        </th>
                                        <td style="padding: 15px; border-bottom: 1px solid #ddd;">다른 상품이 배송되었습니다.</td>
                                    </tr>
                                    <tr>
                                        <th style="padding: 15px; background: #f9f9f9; border-bottom: 1px solid #ddd;">추가 비용
                                            결제</th>
                                        <td style="padding: 15px; border-bottom: 1px solid #ddd;">2,500 원</td>
                                    </tr>
                                    <tr>
