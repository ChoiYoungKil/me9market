    ...
    <div id="contents" style="padding: 120px 0; min-height: 600px;">
        <div class="row">
            <div class="box box1" style="max-width: 1200px; margin: 0 auto; background: #fff; padding: 30px;">
                <div class="page_info">
                    <div class="ttl" style="font-size: 28px; font-weight: bold; margin-bottom: 20px;">반품 상세 내역</div>
                ...
                <div class="conbx">
                    ...
                    <div class="con_w" style="margin-bottom: 40px;">
                        <div class="ttl01"
                            ...
                            반품 상품 <span style="font-size: 14px; color: #e91e63;">판매자 ( txx2212 )</span></div>
                        <div class="tb01">
                                ...
                                <tbody>
                                    <tr>
                                        <td style="padding: 15px; border-bottom: 1px solid #ddd; text-align:center;">
                                            <span
                                                style="display:inline-block; padding: 5px 10px; background:#eee; font-size:12px;">반품완료</span>
                                        </td>
                    ...
                    <div class="con_w" style="margin-bottom: 40px;">
                        ...
                        <div class="tb01">
                            <table style="width: 100%;">
                                ...
                                <tbody class="textL">
                                    <tr>
                                        <th style="padding: 15px; background: #f9f9f9; border-bottom: 1px solid #ddd;">반품 사유
                                        </th>
                                        <td style="padding: 15px; border-bottom: 1px solid #ddd;">
                                            처음 사려고 했던 상품이 상품표기 이상으로 구매를 잘 못 하였습니다.<br>
                                            그래서 반품을 신청합니다.
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="padding: 15px; border-bottom: 1px solid #ddd;">무통장입금 환불 2,000 원</td>
                                    </tr>
                                    <tr>
