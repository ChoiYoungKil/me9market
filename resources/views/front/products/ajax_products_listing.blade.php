                ...
                <div class="item">
                    <div class="image-container">
                        <a class="item-img-wrapper-link" href="{{ url('product/' . $product['id']) }}">
                            ...
                            @if (!empty($product['product_image']) && file_exists($product_image_path)) {{-- 제품 이미지가 데이터베이스
                                테이블과 파일 시스템(서버) 모두에 존재하는 경우 --}}
                    ...
                    <div class="item-content">
                        ...
                        {{-- 제품의 최종 가격을 결정하기 위해 Product.php 모델의 정적 getDiscountPrice() 메서드를 호출합니다. 제품은 '카테고리' 할인 또는 '제품' 할인 두
                        가지로 인해 할인을 받을 수 있기 때문입니다. --}}
                        @php
