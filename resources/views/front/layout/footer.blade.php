        ...
        <div class="outer-footer-wrapper u-s-p-y-80">
            ...
            <form class="newsletter-form">
                ...
                <input type="text" placeholder="Your Email Address" id="subscriber_email" name="subscriber_email"
                    required> {{-- front/js/custom.js의 jQuery에서 HTML id 전역 속성을 사용합니다. --}}
                <button type="button" class="button" onclick="addSubscriber()">SUBMIT</button> {{-- front/js/custom.js의
                addSubscriber() 함수를 확인하세요. <input> 필드의 id="subscriber_email"과 함께 사용합니다. --}}
            </form>
        ...
        <div class="bottom-footer-wrapper">
            <div class="social-media-wrapper">
                <ul class="social-media-list">
                    <li>
                        <a target="_blank" href="{{ url()->current() }}">
            ...
            <p class="copyright-text">Copyright &copy; 2022
                <a target="_blank" rel="nofollow" href="{{ url()->current() }}">Multi-vendor E-commerce Application</a> | All Right Reserved
            </p>
        </div>
    </div>
    <!-- Bottom-Footer /- -->
