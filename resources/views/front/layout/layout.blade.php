...
<head>
    ...
    {{-- 정적 및 동적 SEO(HTML 메타 태그): front/layout/layout.blade.php의 HTML
    <meta> 태그와 <title> 태그를 확인하세요. Front/IndexController.php의 index() 메서드, Front/ProductsController.php의 listing() 메서드,
        Front/ProductsController.php의 detail() 메서드, Front/ProductsController.php의 cart() 메서드를 확인하세요. --}}
        ...
        <title>
            ...
            {{-- 정적 및 동적 SEO(HTML 메타 태그): front/layout/layout.blade.php의 HTML
            <meta> 태그와 <title> 태그를 확인하세요. Front/IndexController.php의 index() 메서드, Front/ProductsController.php의
                listing() 메서드, Front/ProductsController.php의 detail() 메서드, Front/ProductsController.php의 cart() 메서드를
                확인하세요. --}}
                @if (!empty($meta_title))
                    {{ $meta_title }}
                @else
            ...
            {{-- Sub and Board CSS for Notice/FAQ/etc --}}
            <link rel="stylesheet" href="{{ url('front/css/common.css') }}">
            <link rel="stylesheet" href="{{ url('front/css/sub.css') }}">
            <link rel="stylesheet" href="{{ url('front/css/board.css') }}">
...
<body id="@yield('page_type', 'main')">
    ...
    {{-- 자바스크립트 코드 내에서 PHP 코드를 작성할 수 있도록(동적 필터를 동적으로 작동시키기 위해(두 번째 방법)) --}}
