    ...
    <div class="con_bx">
        ...
        <div class="con2">
            ...
            <div class="list_bx">
                <div class="list_w">
                    <ul>
                        <li><a href="{{ route('channel.product_own') }}">- 자사상품 수<span>(5)</span></a></li>
                        <li><a href="{{ route('channel.product_public') }}">- 공유상품 수<span>(5)</span></a></li>
                        <li><a href="{{ route('channel.product_own') }}">- 판매 상품 수<span>(1)</span></a></li>
                        <li><a href="{{ route('channel.shop_list') }}">- 판매채널 수<span>(2)</span></a></li>
                    </ul>
        ...
        <div class="con3">
            @if(isset($dep1_id) && $dep1_id != '00')
                <div class="con_w">
                    <ul class="dep1_wrap">
                        @include('channel.inc.snb' . $dep1_id)
                    </ul>
                </div>
            @endif
            ...
            <div class="con_w">
                ...
                <ul class="dep1_wrap type2">
                    ...
                    <li class="dep1">
                        <a href="{{ route('channel.sub_accounts.list') }}">서브관리자관리</a>
                    </li>
                    <li class="dep1">
                        <a href="{{ route('channel.order.manager') }}">발주담당관리</a>
                    </li>
                    <li class="dep1">
                        <a href="{{ route('channel.point.list') }}">포인트관리</a>
                    </li>
                    <li class="dep1">
                        <a href="{{ route('channel.delivery.list') }}">배송비설정</a>
                    </li>
                    <li class="dep1">
                        <a href="{{ route('channel.refund.list') }}">취소/환불안내</a>
                    </li>
                </ul>
            </div>
        </div>
